...
!    call fld_list_add(fldsFrHyd,"water_surface_height_above_reference_datum"  , "cannot provide","conservefrac")
  ...
  subroutine InitializeP0(gcomp, importState, exportState, clock, rc)
    ...
    call ESMF_AttributeGet(gcomp, name="generate_landmask", value=value, defaultValue="true", &
      convention="NUOPC", purpose="Instance", rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=965, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call ESMF_AttributeGet(gcomp, name="DumpFields", value=value, defaultValue="true", &
      convention="NUOPC", purpose="Instance", rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=973, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call ESMF_AttributeGet(gcomp, name="DumpRHs", value=value, defaultValue="false", &
      convention="NUOPC", purpose="Instance", rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=981, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call ESMF_AttributeGet(gcomp, name="ProfileMemory", value=value, defaultValue="true", &
      convention="NUOPC", purpose="Instance", rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=989, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=997, file="module_MEDIATOR.F90")) return  ! bail out
    clock_invalidTimeStamp = ESMF_ClockCreate(clock, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1000, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine InitializeIPDv03p1(gcomp, importState, exportState, clock, rc)
    ...
    do n = 1,fldsFrAtm%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1054, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsFrOcn%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1068, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsFrIce%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1082, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsFrLnd%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1096, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsFrHyd%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1110, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsToAtm%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1126, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsToOcn%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1140, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsToIce%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1154, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsToLnd%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1168, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
    ...
    do n = 1,fldsToHyd%num
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1182, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
...
!    type(ESMF_XGrid)            :: xgrid
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1226, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1237, file="module_MEDIATOR.F90")) return  ! bail out
...
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=1243, file="module_MEDIATOR.F90")) return  ! bail out

!    gridHyd = NUOPC_GridCreateSimpleSph(0._ESMF_KIND_R8, -85._ESMF_KIND_R8, &
!      360._ESMF_KIND_R8, 85._ESMF_KIND_R8, nx_med, ny_med, &
!      scheme=ESMF_REGRID_SCHEME_FULL3D, rc=rc)
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=1249, file="module_MEDIATOR.F90")) return  ! bail out
...
!gjt: -> eventually comment out the following lines...
    call realizeConnectedFields(NState_AtmImp, &
      ...
      string='AtmImp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1279, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_AtmExp, &
      ...
      string='AtmExp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1287, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_OcnImp, &
      ...
      string='OcnImp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1295, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_OcnExp, &
      ...
      string='OcnExp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1303, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_IceImp, &
      ...
      string='IceImp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1311, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_IceExp, &
      ...
      string='IceExp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1319, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_LndImp, &
      ...
      string='LndImp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1327, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_LndExp, &
      ...
      string='LndExp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1335, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_HydImp, &
      ...
      string='HydImp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1343, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call realizeConnectedFields(NState_HydExp, &
      ...
      string='HydExp',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1351, file="module_MEDIATOR.F90")) return  ! bail out

    ! Clean Up

!    call ESMF_GridDestroy(gridAtm, rc=rc)
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=1357, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    subroutine realizeConnectedFields(state, fieldNameList, grid, string, rc)
      ...
      do n=1, size(fieldNameList)
        if (NUOPC_IsConnected(state, fieldName=fieldNameList(n))) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=1389, file="module_MEDIATOR.F90")) return  ! bail out
          call NUOPC_GetAttribute(field, name="TransferActionGeomObject", &
            value=transferAction, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=1393, file="module_MEDIATOR.F90")) return  ! bail out
          ...
          if (trim(transferAction) == "accept") then
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1417, file="module_MEDIATOR.F90")) return  ! bail out
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=1428, file="module_MEDIATOR.F90")) return  ! bail out
        endif
      enddo
      if (dbug_flag > 5) then
        call ESMF_LogWrite(trim(subname)//": done", ESMF_LOGMSG_INFO, rc=dbrc)
...
!    character(ESMF_MAXSTR)        :: transferAction
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1472, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_atmExp, 'AtmExp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1476, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_ocnImp, 'OcnImp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1480, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_ocnExp, 'OcnExp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1484, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_iceImp, 'IceImp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1488, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_iceExp, 'IceExp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1492, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_lndImp, 'LndImp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1496, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_lndExp, 'LndExp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1500, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_hydImp, 'HydImp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1504, file="module_MEDIATOR.F90")) return  ! bail out

    call realizeConnectedGrid(NState_hydExp, 'HydExp', rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1508, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  contains  !- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    subroutine realizeConnectedGrid(State,string,rc)
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1554, file="module_MEDIATOR.F90")) return  ! bail out

      call ESMF_StateGet(State, itemCount=fieldCount, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1558, file="module_MEDIATOR.F90")) return  ! bail out
...
!tcx    do n=1, 1
        ...
        call ESMF_StateGet(State, field=field, itemName=fieldNameList(n), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=1570, file="module_MEDIATOR.F90")) return  ! bail out
        call NUOPC_GetAttribute(field, name="TransferActionGeomObject", &
          value=transferAction, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=1574, file="module_MEDIATOR.F90")) return  ! bail out
        ...
        if (trim(transferAction) == "accept") then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=1615, file="module_MEDIATOR.F90")) return  ! bail out
          ...
          if (petCount/tileCount * tileCount == petCount) then
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1626, file="module_MEDIATOR.F90")) return  ! bail out
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1638, file="module_MEDIATOR.F90")) return  ! bail out
          ...
          if (dbug_flag > 1) then
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1656, file="module_MEDIATOR.F90")) return  ! bail out
          endif
          ...
          if (localDeCount /= 1) then
            call ESMF_LogSetError(ESMF_RC_INTNRL_BAD, &
              ...
              line=1675, file="module_MEDIATOR.F90", rcToReturn=rc)
            return  ! bail out
          endif
...
!tcx         do n1=1, fieldCount
          do n1=n,n
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1687, file="module_MEDIATOR.F90")) return  ! bail out
            call ESMF_FieldEmptySet(field, grid=grid, rc=rc)    
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1690, file="module_MEDIATOR.F90")) return  ! bail out
            if (dbug_flag > 1) then
              call ESMF_LogWrite(trim(subname)//trim(string)//": attach grid for "//trim(fieldNameList(n1)), ESMF_LOGMSG_INFO, rc=rc)
              if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
                line=1694, file="module_MEDIATOR.F90")) return  ! bail out
            endif
            call Grid_print(grid,trim(fieldNameList(n))//'_new',rc)
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=1698, file="module_MEDIATOR.F90")) return  ! bail out
          enddo
  ...
  subroutine InitializeIPDv03p5(gcomp, importState, exportState, clock, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1759, file="module_MEDIATOR.F90")) return  ! bail out
    call state_reset(NState_atmImp, value=spval_init, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1762, file="module_MEDIATOR.F90")) return  ! bail out

    call completeFieldInitialization(NState_atmExp, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1766, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1773, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1780, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1787, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1794, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1801, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1808, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1815, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1822, file="module_MEDIATOR.F90")) return  ! bail out
...
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=1838, file="module_MEDIATOR.F90")) return  ! bail out

!    call ESMF_StateGet(NState_ocnImp, field=field, itemName=fldsFrOcn%shortname(1), rc=rc)
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=1842, file="module_MEDIATOR.F90")) return  ! bail out

!    call ESMF_FieldGet(field, grid=gridOcn, rc=rc)
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=1846, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_StateGet(NState_atmImp, itemCount=fieldCount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1850, file="module_MEDIATOR.F90")) return  ! bail out
    if (fieldCount > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1858, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_FieldGet(field, grid=gridAtm, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
...
!      call ESMF_LogWrite("MED: aft get fv3grid vtk", ESMF_LOGMSG_INFO, rc=rc)
    ...
    if (fieldCount > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1881, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_StateGet(NState_ocnImp, field=field, itemName=fieldNameList(1), rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1884, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_FieldGet(field, grid=gridOcn, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1887, file="module_MEDIATOR.F90")) return  ! bail out
      deallocate(fieldNameList)
    else
      gridOcn = gridMed
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1895, file="module_MEDIATOR.F90")) return  ! bail out
    if (fieldCount > 0) then
      allocate(fieldNameList(fieldCount))
      call ESMF_StateGet(NState_iceImp, itemNameList=fieldNameList, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1900, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_StateGet(NState_iceImp, field=field, itemName=fieldNameList(1), rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1903, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_FieldGet(field, grid=gridIce, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1906, file="module_MEDIATOR.F90")) return  ! bail out
      deallocate(fieldNameList)
    else
      gridIce = gridMed
    endif
...
! Land will pick up the grid from the first field exported to Land
    ...
    if (fieldCount > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1924, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_FieldGet(field, grid=gridLnd, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1927, file="module_MEDIATOR.F90")) return  ! bail out

      call ESMF_GridGetCoord(gridLnd, staggerloc=ESMF_STAGGERLOC_CENTER, &
        isPresent=isPresent,rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1932, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      call ESMF_GridGetCoord(gridLnd, staggerloc=ESMF_STAGGERLOC_CORNER, &
        isPresent=isPresent,rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=1945, file="module_MEDIATOR.F90")) return  ! bail out
      if (.NOT. isPresent) then
        call NEMS_GridCopyCoord(gridcomp=gcomp, gridSrc=gridAtm, gridDst=gridLnd, &
          staggerloc=(/ESMF_STAGGERLOC_CENTER, ESMF_STAGGERLOC_CORNER/), invert=(/2/), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=1950, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_LogWrite(trim(subname)// &
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=1956, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_LogWrite(trim(subname)// &
...
! Hydro will pick up the grid from the first field exported to Hydro
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=1969, file="module_MEDIATOR.F90")) return  ! bail out
    if (fieldCount > 0) then
      allocate(fieldNameList(fieldCount))
      call ESMF_StateGet(NState_hydExp, itemNameList=fieldNameList, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1974, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_StateGet(NState_hydExp, field=field, itemName=fieldNameList(1), rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1977, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_FieldGet(field, grid=gridHyd, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=1980, file="module_MEDIATOR.F90")) return  ! bail out
      deallocate(fieldNameList)
    else
      gridHyd = gridMed
    endif
!BL2017
    ...
    if (generate_landmask) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=1991, file="module_MEDIATOR.F90")) return
      call ESMF_GridGetItem(gridIce, itemflag=ESMF_GRIDITEM_MASK, staggerLoc=ESMF_STAGGERLOC_CENTER, isPresent=isPresentIce, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=1993, file="module_MEDIATOR.F90")) return
      ...
      if (isPresentOcn .or. isPresentIce) then
        ...
        if (isPresentOcn .and. isPresentIce) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=2004, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=2010, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=2023, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=2031, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=2067, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_RouteHandleIsCreated(RH_mapmask, rc=rc)) then
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=2075, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,line=2101, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,line=2107, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,line=2114, file="module_MEDIATOR.F90")) return
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,line=2118, file="module_MEDIATOR.F90")) return
          call ESMF_FieldDestroy(fieldOcn,rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,line=2120, file="module_MEDIATOR.F90")) return
...
!BL2017
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2151, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Print(gridOcn,'gridOcn',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2155, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Print(gridIce,'gridIce',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2159, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Print(gridLnd,'gridLnd',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2163, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Print(gridHyd,'gridHyd',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2167, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Print(gridMed,'gridMed',rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2171, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2194, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Write(gridHyd, 'array_med_hyd', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2198, file="module_MEDIATOR.F90")) return  ! bail out

    call Grid_Write(gridMed, 'array_med_med', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2202, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2214, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2225, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_init(is_local%wrap%FBAtm_o, grid=gridOcn, &
      state=NState_AtmImp, name='FBAtm_o', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2230, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2266, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_init(is_local%wrap%FBOcn_o, grid=gridOcn, &
      state=NState_OcnImp, name='FBOcn_o', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2271, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2287, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_init(is_local%wrap%FBIce_o, grid=gridOcn, &
      state=NState_IceImp, name='FBIce_o', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2292, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2309, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_init(is_local%wrap%FBLnd_l, grid=gridLnd, &
      state=NState_LndImp, name='FBLnd_l', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2314, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2326, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_init(is_local%wrap%FBHyd_a, grid=gridAtm, &
      state=NState_HydImp, name='FBHyd_a', rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2331, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2350, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2388, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2402, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2440, file="module_MEDIATOR.F90")) return  ! bail out
    if (fieldCount > 0) then
      call ESMF_FieldBundleGet(is_local%wrap%FBforOcn, fieldCount=fieldCount, rc=rc) ! Ocean Import Field Count
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2444, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2456, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2462, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
    ...
    if (fieldCount > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2475, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
    ...
    if (fieldCount > 0) then
      call ESMF_FieldBundleGet(is_local%wrap%FBforAtm, fieldCount=fieldCount, rc=rc) ! Atmosphere Import Field Count
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2494, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
    ...
    if (fieldCount > 0) then
      call ESMF_FieldBundleGet(is_local%wrap%FBforAtm, fieldCount=fieldCount, rc=rc) ! Atmosphere Import Field Count
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2513, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
    ...
    if (fieldCount > 0) then
      call ESMF_FieldBundleGet(is_local%wrap%FBforLnd, fieldCount=fieldCount, rc=rc) ! Land Import Field Count
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2532, file="module_MEDIATOR.F90")) return  ! bail out
      if (fieldCount > 0) then
    ...
    if (is_local%wrap%a2o_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2594, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%a2l_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2621, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%a2h_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2633, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%o2i_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2661, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%i2o_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2689, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%l2a_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2701, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%l2h_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2713, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%h2a_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2725, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%h2l_active) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2737, file="module_MEDIATOR.F90")) return  ! bail out
    endif
  ...
  contains  !- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    subroutine completeFieldInitialization(State,rc)
      ...
      call ESMF_StateGet(State, itemCount=fieldCount, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2768, file="module_MEDIATOR.F90")) return  ! bail out
      allocate(fieldNameList(fieldCount))
      call ESMF_StateGet(State, itemNameList=fieldNameList, &
        itemorderflag=ESMF_ITEMORDER_ADDORDER, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2773, file="module_MEDIATOR.F90")) return  ! bail out

      do n=1, fieldCount

        call ESMF_StateGet(State, field=field, itemName=fieldNameList(n), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=2779, file="module_MEDIATOR.F90")) return  ! bail out
        ...
        if (fieldStatus==ESMF_FIELDSTATUS_GRIDSET) then 
          if (dbug_flag > 1) then
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=2790, file="module_MEDIATOR.F90")) return  ! bail out
          endif
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=2797, file="module_MEDIATOR.F90")) return  ! bail out
          ! access the transferred Grid to use for other fields
          call ESMF_FieldGet(field, grid=grid, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=2802, file="module_MEDIATOR.F90")) return  ! bail out
        else
          if (dbug_flag > 1) then
            call ESMF_LogWrite(subname//" is accepting INTERNAL grid for field "//trim(fieldNameList(n)), &
              ESMF_LOGMSG_INFO, rc=rc)
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=2808, file="module_MEDIATOR.F90")) return  ! bail out
          endif
          ! now use the Grid object in other fields
          call ESMF_FieldEmptySet(field, grid=grid, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=2813, file="module_MEDIATOR.F90")) return  ! bail out
          call ESMF_FieldEmptyComplete(field, typekind=ESMF_TYPEKIND_R8, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=2816, file="module_MEDIATOR.F90")) return  ! bail out
        endif   ! accept
  ...
  subroutine DataInitialize(gcomp, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2863, file="module_MEDIATOR.F90")) return  ! bail out
    
    ! Get the internal state from Component.
    nullify(is_local%wrap)
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2869, file="module_MEDIATOR.F90")) return  ! bail out

    ! get the current time out of the clock
    call ESMF_ClockGet(clock, currTime=time, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=2874, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    do n = 1,fldsFrAtm%num
      ...
      if (itemType /= ESMF_STATEITEM_NOTFOUND) then
        ...
        if (connected) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=2897, file="module_MEDIATOR.F90")) return  ! bail out
          if (.not.atCorrectTime) then
            call ESMF_LogWrite("MED - Initialize-Data-Dependency NOT YET SATISFIED!!!", &
              ESMF_LOGMSG_INFO, rc=rc)
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=2902, file="module_MEDIATOR.F90")) return  ! bail out
            allDone = .false.
    ...
    if (allDone) then
      ...
      call state_reset(NState_atmImp, value=spval_init, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2936, file="module_MEDIATOR.F90")) return  ! bail out

      call state_reset(NState_ocnImp, value=spval_init, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2940, file="module_MEDIATOR.F90")) return  ! bail out

      call state_reset(NState_iceImp, value=spval_init, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2944, file="module_MEDIATOR.F90")) return  ! bail out

      call state_reset(NState_lndImp, value=spval_init, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2948, file="module_MEDIATOR.F90")) return  ! bail out

      call state_reset(NState_hydImp, value=spval_init, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2952, file="module_MEDIATOR.F90")) return  ! bail out

      call fieldBundle_reset(is_local%wrap%FBaccumAtm, value=czero, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2956, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      !if (.not.coldstart) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=2987, file="module_MEDIATOR.F90")) return  ! bail out
      !endif
      ...
      call ESMF_StateGet(NState_IceExp, itemName='s_surf', &
        itemType=itemType, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=2994, file="module_MEDIATOR.F90")) return  ! bail out
      if (itemType /= ESMF_STATEITEM_NOTFOUND) then
        if (NUOPC_IsConnected(NState_IceExp,'s_surf',rc=rc)) then
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=2998, file="module_MEDIATOR.F90")) return  ! bail out
          call State_SetFldPtr(NState_IceExp, 's_surf', 34.0_ESMF_KIND_R8, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3001, file="module_MEDIATOR.F90")) return  ! bail out
        endif
  ...
  subroutine SetRunClock(gcomp, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3036, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3049, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine MedPhase_fast_before(gcomp, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3095, file="module_MEDIATOR.F90")) return  ! bail out
    call MedPhase_prep_ice(gcomp,rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3098, file="module_MEDIATOR.F90")) return  ! bail out
    call MedPhase_prep_lnd(gcomp,rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3101, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
    ...
    call ESMF_GridCompGet(gcomp, clock=clock, importState=importState, &
      exportState=exportState, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3155, file="module_MEDIATOR.F90")) return  ! bail out
      
    ! Get the internal state from Component.
    nullify(is_local%wrap)
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3161, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (dbug_flag > 1) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3174, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
...
!BL2017b
    ...
    if (is_local%wrap%o2a_active) then
      call Fieldbundle_Regrid(fldsFrOcn, is_local%wrap%FBOcn_o, is_local%wrap%FBOcn_a, &
         ...
         string='o2a', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3238, file="module_MEDIATOR.F90")) return  ! bail out
...
! use the nearest neighbor method
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3246, file="module_MEDIATOR.F90")) return  ! bail out

      call ESMF_FieldBundleGet(is_local%wrap%FBOcn_a, fieldCount=fieldCount, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3250, file="module_MEDIATOR.F90")) return  ! bail out
      allocate(fieldNameList(fieldCount))
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3259, file="module_MEDIATOR.F90")) return  ! bail out

      call FieldBundle_GetFldPtr(is_local%wrap%FBOcn2_a, fieldNameList(n), dataPtr2, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3263, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3283, file="module_MEDIATOR.F90")) return  ! bail out
...
! use the nearest neighbor method
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3291, file="module_MEDIATOR.F90")) return  ! bail out

      call ESMF_FieldBundleGet(is_local%wrap%FBAtmOcn_a, fieldCount=fieldCount, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3295, file="module_MEDIATOR.F90")) return  ! bail out
      allocate(fieldNameList(fieldCount))
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3304, file="module_MEDIATOR.F90")) return  ! bail out

      call FieldBundle_GetFldPtr(is_local%wrap%FBAtmOcn2_a, fieldNameList(n), dataPtr2, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3308, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
    ...
    if (is_local%wrap%i2a_active) then
      if (FieldBundle_FldChk(is_local%wrap%FBIce_i, 'ice_fraction', rc=rc) .and. &
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=3333, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
        !--- need to add the nearest neighbor regridding method here - B Li
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3346, file="module_MEDIATOR.F90")) return  ! bail out

          call FieldBundle_GetFldPtr(is_local%wrap%FBIce2_a,'ice_fraction', dataPtr5, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3350, file="module_MEDIATOR.F90")) return  ! bail out
!BL2017b
...
!BL2017b
        ...
        if (ESMF_RouteHandleIsCreated(is_local%wrap%RH_i2a_consd, rc=rc)) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3397, file="module_MEDIATOR.F90")) return  ! bail out
!BL2017b
          !--- copy out the ifrac on atm grid
          call FieldBundle_GetFldPtr(is_local%wrap%FBIce_a, 'ice_fraction', dataPtr2, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3402, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
        ...
        if (ESMF_RouteHandleIsCreated(is_local%wrap%RH_i2a_bilnr, rc=rc)) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3439, file="module_MEDIATOR.F90")) return  ! bail out

          !--- copy out the ifrac on ice grid and ifrac on atm grid
          call FieldBundle_GetFldPtr(is_local%wrap%FBIce_a, 'ice_fraction', dataPtr2, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3444, file="module_MEDIATOR.F90")) return  ! bail out
        ...
        if (ESMF_RouteHandleIsCreated(is_local%wrap%RH_i2a_patch, rc=rc)) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3474, file="module_MEDIATOR.F90")) return  ! bail out

          !--- copy out the ifrac on ice grid and ifrac on atm grid
          call FieldBundle_GetFldPtr(is_local%wrap%FBIce_a, 'ice_fraction', dataPtr2, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=3479, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
        ...
        call Fieldbundle_Regrid(fldsFrIce, is_local%wrap%FBIce_i, is_local%wrap%FBIce_a, &
           ...
           string='i2a', rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=3609, file="module_MEDIATOR.F90")) return  ! bail out

        call Fieldbundle_Regrid2(fldsFrIce, is_local%wrap%FBIce_i, is_local%wrap%FBIce2_a, &
         nearestmap=is_local%wrap%RH_i2a_nearest, &
         string='i2a_nearest', rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=3615, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017b
    ...
    if (is_local%wrap%l2a_active) then
      call Fieldbundle_Regrid(fldsFrLnd, is_local%wrap%FBLnd_l, is_local%wrap%FBLnd_a, &
         ...
         string='l2a', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3644, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (statewrite_flag) then
      ...
      call ESMF_FieldBundleWrite(is_local%wrap%FBOcn_a, 'fields_med_ocn_a.nc', &
        ...
        iofmt=ESMF_IOFMT_NETCDF, rc=rc)  
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3683, file="module_MEDIATOR.F90")) return  ! bail out

      call ESMF_FieldBundleWrite(is_local%wrap%FBIce_a, 'fields_med_ice_a.nc', &
        singleFile=.true., overwrite=.true., timeslice=is_local%wrap%fastcntr, &
        iofmt=ESMF_IOFMT_NETCDF, rc=rc)  
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3689, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3701, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017      ocnwgt = 1.0_ESMF_KIND_R8 - icewgt
    ...
    if (generate_landmask) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3715, file="module_MEDIATOR.F90")) return  ! bail out
      do j=lbound(dataPtr3,2),ubound(dataPtr3,2)
      do i=lbound(dataPtr3,1),ubound(dataPtr3,1)
...
!BL2017b
      ...
      call ESMF_LogWrite(trim(subname)//": ERROR generate_landmask must be true ", ESMF_LOGMSG_ERROR, line=3724, file="module_MEDIATOR.F90", rc=dbrc)
      rc = ESMF_FAILURE
      return
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3735, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3741, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3747, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3753, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3759, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3765, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3787, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    ! write the fields exported to atm to file
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=3804, file="module_MEDIATOR.F90")) return  ! bail out
    endif
  ...
  subroutine TimestampExport_prep_atm(gcomp, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3964, file="module_MEDIATOR.F90")) return  ! bail out

    ! set the Clock to have the current time as the driverClock
    call ESMF_ClockGet(driverClock, currTime=currTime, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3969, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_ClockSet(Clock, currTime=currTime, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3972, file="module_MEDIATOR.F90")) return  ! bail out

    ! Get the internal state from Component.
    nullify(is_local%wrap)
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3978, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=3990, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2018
    ...
    call ESMF_GridCompGet(gcomp, clock=clock, importState=importState, &
      exportState=exportState, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4082, file="module_MEDIATOR.F90")) return  ! bail out
      
    ! Get the internal state from Component.
    nullify(is_local%wrap)
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4088, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_ClockGet(clock,currtime=time,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4092, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeGet(time,timestring=timestr)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4095, file="module_MEDIATOR.F90")) return  ! bail out
    if (dbug_flag > 1) then
      call ESMF_LogWrite(trim(subname)//": time = "//trim(timestr), ESMF_LOGMSG_INFO, rc=dbrc)
    endif
    ...
    if (dbug_flag > 1) then
      call ESMF_ClockPrint(clock, options="currTime", &
        ...
        unit=msgString, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4105, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4108, file="module_MEDIATOR.F90")) return  ! bail out
    endif
...
!BL2017
    ...
    if (is_local%wrap%a2i_active) then
      call Fieldbundle_Regrid(fldsFrAtm, is_local%wrap%FBAtm_a, is_local%wrap%FBAtm_i, &
         ...
         string='a2i', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4192, file="module_MEDIATOR.F90")) return  ! bail out
...
!BL2017
    ...
    if (is_local%wrap%o2i_active) then
      call Fieldbundle_Regrid(fldsFrOcn, is_local%wrap%FBOcn_o, is_local%wrap%FBOcn_i, &
         ...
         string='o2i', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4239, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4291, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4303, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (statewrite_flag) then
      ...
      call NUOPC_Write(NState_IceExp, &
        ...
        relaxedFlag=.true., rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4316, file="module_MEDIATOR.F90")) return  ! bail out
    endif
  ...
  subroutine MedPhase_prep_lnd(gcomp, rc)
    ...
    call ESMF_GridCompGet(gcomp, clock=clock, importState=importState, &
      exportState=exportState, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4357, file="module_MEDIATOR.F90")) return  ! bail out
      
    ! Get the internal state from Component.
    nullify(is_local%wrap)
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4363, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_ClockGet(clock,currtime=time,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4367, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeGet(time,timestring=timestr)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4370, file="module_MEDIATOR.F90")) return  ! bail out
    if (dbug_flag > 1) then
      call ESMF_LogWrite(trim(subname)//": time = "//trim(timestr), ESMF_LOGMSG_INFO, rc=dbrc)
    endif
    ...
    if (dbug_flag > 1) then
      call ESMF_ClockPrint(clock, options="currTime", &
        ...
        unit=msgString, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4380, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4383, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%a2l_active) then
      call Fieldbundle_Regrid(fldsFrAtm, is_local%wrap%FBAtm_a, is_local%wrap%FBAtm_l, &
         ...
         string='a2l', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4435, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4473, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4485, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (statewrite_flag) then
      ...
      call NUOPC_Write(NState_LndExp, &
        ...
        relaxedFlag=.true., rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4498, file="module_MEDIATOR.F90")) return  ! bail out
    endif
  ...
  subroutine MedPhase_prep_hyd(gcomp, rc)
    ...
    call ESMF_GridCompGet(gcomp, clock=clock, importState=importState, &
      exportState=exportState, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4539, file="module_MEDIATOR.F90")) return  ! bail out
      
    ! Get the internal state from Component.
    nullify(is_local%wrap)
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4545, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_ClockGet(clock,currtime=time,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4549, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeGet(time,timestring=timestr)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4552, file="module_MEDIATOR.F90")) return  ! bail out
    if (dbug_flag > 1) then
      call ESMF_LogWrite(trim(subname)//": time = "//trim(timestr), ESMF_LOGMSG_INFO, rc=dbrc)
    endif
    ...
    if (dbug_flag > 1) then
      call ESMF_ClockPrint(clock, options="currTime", &
        ...
        unit=msgString, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4562, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4565, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (is_local%wrap%a2h_active) then
      call Fieldbundle_Regrid(fldsFrAtm, is_local%wrap%FBAtm_a, is_local%wrap%FBAtm_h, &
         ...
         string='a2h', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4617, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4655, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4667, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (statewrite_flag) then
      ...
      call NUOPC_Write(NState_HydExp, &
        ...
        relaxedFlag=.true., rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4680, file="module_MEDIATOR.F90")) return  ! bail out
    endif
  ...
  subroutine MedPhase_fast_after(gcomp, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4728, file="module_MEDIATOR.F90")) return  ! bail out
    call MedPhase_accum_fast(gcomp,rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4731, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine MedPhase_accum_fast(gcomp, rc)
    ...
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4770, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_ClockGet(clock,currtime=time,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4774, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeGet(time,timestring=timestr)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4777, file="module_MEDIATOR.F90")) return  ! bail out
    if (dbug_flag > 1) then
      call ESMF_LogWrite(trim(subname)//": time = "//trim(timestr), ESMF_LOGMSG_INFO, rc=dbrc)
    endif
    ...
    if (dbug_flag > 1) then
      ...
      call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4790, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (statewrite_flag) then
      ...
      call NUOPC_Write(NState_AtmImp, &
        ...
        relaxedFlag=.true., rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4801, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      call NUOPC_Write(NState_HydImp, &
        ...
        relaxedFlag=.true., rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=4826, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=4867, file="module_MEDIATOR.F90")) return  ! bail out
...
!      line=5089, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5114, file="module_MEDIATOR.F90")) return  ! bail out
...
!tcx include this for the time being to get over the initialization hump
  ...
  subroutine MedPhase_slow(gcomp, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5227, file="module_MEDIATOR.F90")) return  ! bail out
...
!    real(ESMF_KIND_R8), pointer :: dataPtr1(:,:),dataPtr2(:,:),dataPtr3(:,:)
    ...
    call ESMF_GridCompGet(gcomp, clock=clock, importState=importState, &
      exportState=exportState, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5270, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call ESMF_ClockGet(clock,currtime=time,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5280, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeGet(time,timestring=timestr)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5283, file="module_MEDIATOR.F90")) return  ! bail out
    if (dbug_flag > 1) then
      call ESMF_LogWrite(trim(subname)//": time = "//trim(timestr), ESMF_LOGMSG_INFO, rc=dbrc)
    endif
    ...
    if (dbug_flag > 1) then
      call ESMF_ClockPrint(clock, options="currTime", &
        ...
        unit=msgString, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5293, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5296, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (statewrite_flag) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5306, file="module_MEDIATOR.F90")) return  ! bail out
    endif
...
!BL2017
    ...
    if (is_local%wrap%i2o_active) then
      ...
      call FieldBundle_Regrid(fldsFrIce, is_local%wrap%FBaccumIce, is_local%wrap%FBIce_o, &
        ...
        string='i2o', rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5406, file="module_MEDIATOR.F90")) return  ! bail out
    endif
...
!    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5452, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    do i=lbound(icewgt,1),ubound(icewgt,1)
      ...
      if (abs(atmwgt(i,j) + icewgt(i,j) - 1.0_ESMF_KIND_R8) > 1.0e-12 .or. &
        ...
        call ESMF_LogWrite(trim(subname)//": ERROR atm + ice fracs inconsistent", ESMF_LOGMSG_ERROR, line=5476, file="module_MEDIATOR.F90", rc=dbrc)
        rc = ESMF_FAILURE
        return
      endif
    enddo
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn     , 'mean_evap_rate'             , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5493, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn, 'mean_fresh_water_to_ocean_rate', &
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5526, file="module_MEDIATOR.F90")) return  ! bail out
...
!                                rc=rc)
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=5533, file="module_MEDIATOR.F90")) return  ! bail out
...
! hycom uses latent heat flux
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn     , 'mean_laten_heat_flx'             , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5542, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn     , 'mean_sensi_heat_flx'             , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5549, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn     , 'mean_net_lw_flx'   , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5557, file="module_MEDIATOR.F90")) return  ! bail out
...
!                                rc=rc)
!    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!      line=5565, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn, 'mean_salt_rate', &
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5575, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn     , 'mean_zonal_moment_flx'  , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5587, file="module_MEDIATOR.F90")) return  ! bail out
...
!    customwgt = (1.0 - 0.06)
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn,'mean_net_sw_flx' , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5608, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn,'mean_net_sw_vis_dir_flx' , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5615, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn,'mean_net_sw_vis_dif_flx' , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5622, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn,'mean_net_sw_ir_dir_flx' , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5629, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_FieldMerge(is_local%wrap%FBforOcn,'mean_net_sw_ir_dif_flx' , & 
                                ...
                                rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5636, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    call fieldBundle_reset(is_local%wrap%FBaccumAtm, value=czero, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5657, file="module_MEDIATOR.F90")) return  ! bail out

    is_local%wrap%accumcntIce = 0
    call fieldBundle_reset(is_local%wrap%FBaccumIce, value=czero, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5662, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5677, file="module_MEDIATOR.F90")) return  ! bail out
...
!tcx      call FieldBundle_diagnose(is_local%wrap%FBaccumAtmOcn, trim(subname)//' FBacc_AFzero ', rc=rc)
    ...
    if (statewrite_flag) then
      ...
      call NUOPC_Write(NState_OcnExp, &
        ...
        relaxedFlag=.true., rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5716, file="module_MEDIATOR.F90")) return  ! bail out
    endif
...
!    call ESMF_Finalize(endflag=ESMF_END_ABORT)
  ...
  subroutine MedPhase_write_restart(gcomp, rc)
    ...
    if (restart_interval > 0) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5767, file="module_MEDIATOR.F90")) return  ! bail out

      elapsedTime = currTime - startTime

      call ESMF_TimeIntervalGet(elapsedTime,s_i8=sec8,rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5773, file="module_MEDIATOR.F90")) return  ! bail out 
      ...
      if (mod(sec8,restart_interval) == 0) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=5781, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine Finalize(gcomp, importState, exportState, clock, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5819, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5832, file="module_MEDIATOR.F90")) return  ! bail out
...
!      line=5837, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5841, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_clean(is_local%wrap%FBaccumLnd, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5845, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_clean(is_local%wrap%FBaccumHyd, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5849, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5857, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_clean(is_local%wrap%FBforOcn, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5861, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_clean(is_local%wrap%FBforIce, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5865, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_clean(is_local%wrap%FBforLnd, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5869, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_clean(is_local%wrap%FBforHyd, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5873, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine Mediator_restart(gcomp,mode,bfname,rc)
    ...
    if (mode /= 'write' .and. mode /= 'read') then
      call ESMF_LogWrite(trim(subname)//": ERROR mode not allowed "//trim(mode), ESMF_LOGMSG_ERROR, line=5913, file="module_MEDIATOR.F90", rc=dbrc)
      rc = ESMF_FAILURE
      return
    endif
    ...
    call ESMF_GridCompGetInternalState(gcomp, is_local, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5922, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5932, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5943, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5948, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5953, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=5980, file="module_MEDIATOR.F90")) return  ! bail out
    if (mode == 'read') then
      call fieldBundle_copy(NState_IceImp, is_local%wrap%FBIce_i, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=5984, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6000, file="module_MEDIATOR.F90")) return  ! bail out
    if (mode == 'read') then
      call fieldBundle_copy(NState_LndImp, is_local%wrap%FBLnd_l, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6004, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (mode == 'read') then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6014, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6020, file="module_MEDIATOR.F90")) return  ! bail out
...
!        read (funit,*) is_local%wrap%accumcntHyd
  ...
  subroutine FieldBundle_RWFields(mode,fname,FB,flag,rc)
    ...
    if (mode == 'write') then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6096, file="module_MEDIATOR.F90")) return  ! bail out
...
!        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!          line=6108, file="module_MEDIATOR.F90")) call ESMF_LogWrite(trim(subname)//' WARNING missing fields',rc=dbrc)
!-----------------------------------------------------------------------------------------------------
        call ESMF_FieldBundleGet(FB, fieldCount=fieldCount, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6112, file="module_MEDIATOR.F90")) return  ! bail out
        do n = 1,fieldCount
          call fieldBundle_getName(FB, n, name, rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6116, file="module_MEDIATOR.F90")) return  ! bail out
          call fieldBundle_getFieldN(FB, n, field, rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6119, file="module_MEDIATOR.F90")) return  ! bail out
          call ESMF_FieldRead (field, fname, iofmt=ESMF_IOFMT_NETCDF, rc=rc)  
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6122, file="module_MEDIATOR.F90")) call ESMF_LogWrite(trim(subname)//' WARNING missing field '//trim(name),rc=dbrc)
        enddo
...
! This subroutine requires ESMFv8 - for coupled FV3
  ...
  subroutine Compute_RHs(FBsrc, FBdst, bilnrmap, consfmap, consdmap, patchmap, fcopymap, &
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6376, file="module_MEDIATOR.F90")) return  ! bail out

    call fieldBundle_getFieldN(FBdst, 1, flddst, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6380, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (do_bilnr) then
      call ESMF_FieldRegridStore(fldsrc, flddst, routehandle=bilnrmap, &
        ...
        unmappedaction=ESMF_UNMAPPEDACTION_IGNORE, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6395, file="module_MEDIATOR.F90")) return  ! bail out
      if (rhprint_flag) then
        call NUOPC_Write(factorList, "array_med_"//trim(lstring)//"_bilnr.nc", rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6406, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_RouteHandlePrint(bilnrmap, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6409, file="module_MEDIATOR.F90")) return  ! bail out
      endif
    ...
    if (do_consf) then
      call ESMF_FieldRegridStore(fldsrc, flddst, routehandle=consfmap, &
        ...
        unmappedaction=ESMF_UNMAPPEDACTION_IGNORE, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6431, file="module_MEDIATOR.F90")) return  ! bail out
      if (rhprint_flag) then
        call NUOPC_Write(factorList, "array_med_"//trim(lstring)//"_consf.nc", rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6442, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_RouteHandlePrint(consfmap, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6445, file="module_MEDIATOR.F90")) return  ! bail out
      endif
    ...
    if (do_consd) then
      ...
      if (rhprint_flag) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6471, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_RouteHandlePrint(consdmap, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6474, file="module_MEDIATOR.F90")) return  ! bail out
      endif
    ...
    if (do_nearest) then
      call ESMF_FieldRegridStore(fldsrc, flddst, routehandle=nearestmap, &
        ...
        unmappedaction=ESMF_UNMAPPEDACTION_IGNORE, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6495, file="module_MEDIATOR.F90")) return  ! bail out
      if (rhprint_flag) then
        call NUOPC_Write(factorList, "array_med_"//trim(lstring)//"_nearest.nc", rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6499, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_RouteHandlePrint(nearestmap, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6502, file="module_MEDIATOR.F90")) return  ! bail out
      endif
    ...
    if (do_patch) then
      call ESMF_FieldRegridStore(fldsrc, flddst, routehandle=patchmap, &
        ...
        unmappedaction=ESMF_UNMAPPEDACTION_IGNORE, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6524, file="module_MEDIATOR.F90")) return  ! bail out
      if (rhprint_flag) then
        call NUOPC_Write(factorList, "array_med_"//trim(lstring)//"_patch.nc", rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6528, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_RouteHandlePrint(patchmap, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6531, file="module_MEDIATOR.F90")) return  ! bail out
      endif
    ...
    if (do_fcopy) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6549, file="module_MEDIATOR.F90")) return  ! bail out
      if (rhprint_flag) then
  ...
  subroutine Grid_CreateCoords(gridNew,gridOld,rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6599, file="module_MEDIATOR.F90")) return  ! bail out
...
!       localDECount=localDECount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6605, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6625, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6633, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    do localDE = 0,localDeCount-1
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6640, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_GridGetCoord(gridnew, coordDim=1, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CENTER, farrayPtr=dataPtr2, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6644, file="module_MEDIATOR.F90")) return  ! bail out
      dataPtr2 = dataPtr1

      call ESMF_GridGetCoord(gridold, coordDim=2, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CENTER, farrayPtr=dataPtr1, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6650, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_GridGetCoord(gridnew, coordDim=2, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CENTER, farrayPtr=dataPtr2, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6654, file="module_MEDIATOR.F90")) return  ! bail out
      dataPtr2 = dataPtr1

      call ESMF_GridGetCoord(gridold, coordDim=1, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CORNER, farrayPtr=dataPtr1, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6660, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_GridGetCoord(gridnew, coordDim=1, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CORNER, farrayPtr=dataPtr2, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6664, file="module_MEDIATOR.F90")) return  ! bail out
      dataPtr2 = dataPtr1

      call ESMF_GridGetCoord(gridold, coordDim=2, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CORNER, farrayPtr=dataPtr1, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6670, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_GridGetCoord(gridnew, coordDim=2, localDE=localDE,  &
        staggerLoc=ESMF_STAGGERLOC_CORNER, farrayPtr=dataPtr2, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6674, file="module_MEDIATOR.F90")) return  ! bail out
      dataPtr2 = dataPtr1
  ...
  subroutine fieldBundle_initFromFB(FBout, FBin, grid, name, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6720, file="module_MEDIATOR.F90")) return  ! bail out
    allocate(fieldNameList(fieldCount))
    call ESMF_FieldBundleGet(FBin, fieldNameList=fieldNameList, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6724, file="module_MEDIATOR.F90")) return  ! bail out
    if (present(grid)) then
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6735, file="module_MEDIATOR.F90")) return  ! bail out
    endif
    deallocate(fieldNameList)
  ...
  subroutine fieldBundle_init(FieldBundle, fieldNameList, grid, State, name, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6792, file="module_MEDIATOR.F90")) return  ! bail out

    if (present(fieldNameList)) then
      do n = 1, size(fieldNameList)
        field = ESMF_FieldCreate(grid, ESMF_TYPEKIND_R8, name=fieldNameList(n), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6798, file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_FieldBundleAdd(FieldBundle, (/field/), rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=6801, file="module_MEDIATOR.F90")) return  ! bail out
        if (dbug_flag > 1) then
    ...
    if (present(State)) then
      call ESMF_StateGet(State, itemCount=fieldCount, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6811, file="module_MEDIATOR.F90")) return  ! bail out
      allocate(lfieldNameList(fieldCount))
      call ESMF_StateGet(State, itemNameList=lfieldNameList, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=6815, file="module_MEDIATOR.F90")) return  ! bail out
      do n = 1, fieldCount
        if (present(grid)) then
          ...
          call ESMF_FieldBundleAdd(FieldBundle, (/field/), rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6823, file="module_MEDIATOR.F90")) return  ! bail out
          if (dbug_flag > 1) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6831, file="module_MEDIATOR.F90")) return  ! bail out
          call ESMF_FieldGet(lfield, grid=lgrid, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6834, file="module_MEDIATOR.F90")) return  ! bail out

          field = ESMF_FieldCreate(lgrid, ESMF_TYPEKIND_R8, name=lfieldNameList(n), rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6838, file="module_MEDIATOR.F90")) return  ! bail out
          call ESMF_FieldBundleAdd(FieldBundle, (/field/), rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=6841, file="module_MEDIATOR.F90")) return  ! bail out
          if (dbug_flag > 1) then
            call ESMF_LogWrite(trim(subname)//":"//trim(lname)//":add  "//trim(lfieldNameList(n)), ESMF_LOGMSG_INFO, rc=dbrc)
          endif
        endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6852, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine fieldBundle_getName(FieldBundle, fieldnum, fieldname, rc)
    ...
    if (fieldnum > fieldCount) then
      call ESMF_LogWrite(trim(subname)//": ERROR fieldnum > fieldCount ", ESMF_LOGMSG_ERROR, line=6887, file="module_MEDIATOR.F90", rc=dbrc)
      rc = ESMF_FAILURE
      return
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6895, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine fieldBundle_getFieldN(FieldBundle, fieldnum, field, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6929, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_FieldBundleGet(FieldBundle, fieldName=name, field=field, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6933, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine fieldBundle_getFieldName(FieldBundle, fieldname, field, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6962, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine fieldBundle_clean(FieldBundle, rc)
    ...
    call ESMF_FieldBundleGet(FieldBundle, fieldCount=fieldCount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=6993, file="module_MEDIATOR.F90")) return  ! bail out
    allocate(fieldNameList(fieldCount))
    call ESMF_FieldBundleGet(FieldBundle, fieldNameList=fieldNameList, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
    ...
    do n = 1, fieldCount
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7001, file="module_MEDIATOR.F90")) return  ! bail out
      call ESMF_FieldDestroy(field, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7004, file="module_MEDIATOR.F90")) return  ! bail out
    enddo
  ...
  subroutine fieldBundle_reset(FieldBundle, value, rc)
    ...
    call ESMF_FieldBundleGet(FieldBundle, fieldCount=fieldCount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7048, file="module_MEDIATOR.F90")) return  ! bail out
    allocate(fieldNameList(fieldCount))
    call ESMF_FieldBundleGet(FieldBundle, fieldNameList=fieldNameList, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7052, file="module_MEDIATOR.F90")) return  ! bail out
    do n = 1, fieldCount
      call FieldBundle_GetFldPtr(FieldBundle, fieldNameList(n), dataPtr, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7056, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine FieldBundle_FieldCopy(FBin,fldin,FBout,fldout,rc)
    ...
    if (FieldBundle_FldChk(FBin , trim(fldin) , rc=rc) .and. &
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7100, file="module_MEDIATOR.F90")) return  ! bail out
      call FieldBundle_GetFldPtr(FBout, trim(fldout), dataPtrOut, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7103, file="module_MEDIATOR.F90")) return  ! bail out

      if (.not.FldPtr_SameCheck(dataPtrIn, dataPtrOut, subname, rc)) then
        call ESMF_LogWrite(trim(subname)//": ERROR fname not present with FBin", ESMF_LOGMSG_ERROR, line=7106, file="module_MEDIATOR.F90", rc=dbrc)
        rc = ESMF_FAILURE
        return
      endif
      ...
      if (FieldBundle_FldChk(FBin , fldlist%shortname(n), rc=rc) .and. &
        ...
        if (fldlist%mapping(n) == 'bilinear') then
          if (.not. okbilnr) then
            call ESMF_LogWrite(trim(subname)//trim(lstring)//": ERROR RH not available for "//trim(fldlist%mapping(n))// &
              ": fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_ERROR, line=7202, file="module_MEDIATOR.F90", rc=dbrc)
            rc = ESMF_FAILURE
            return
          endif
          call FieldBundle_FieldRegrid(FBin,fldlist%shortname(n), &
                                       ...
                                       bilnrmap,rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=7210, file="module_MEDIATOR.F90")) return  ! bail out

        elseif (fldlist%mapping(n) == "conservefrac") then
          if (.not. okconsf) then
            call ESMF_LogWrite(trim(subname)//trim(lstring)//": ERROR RH not available for "//trim(fldlist%mapping(n))// &
              ": fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_ERROR, line=7215, file="module_MEDIATOR.F90", rc=dbrc)
            rc = ESMF_FAILURE
            return
          endif
          call FieldBundle_FieldRegrid(FBin ,fldlist%shortname(n), &
                                       ...
                                       consfmap, rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=7223, file="module_MEDIATOR.F90")) return  ! bail out

        elseif (fldlist%mapping(n) == "conservedst") then
          if (.not. okconsd) then
            call ESMF_LogWrite(trim(subname)//trim(lstring)//": ERROR RH not available for "//trim(fldlist%mapping(n))// &
              ": fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_ERROR, line=7228, file="module_MEDIATOR.F90", rc=dbrc)
            rc = ESMF_FAILURE
            return
          endif
          call FieldBundle_FieldRegrid(FBin ,fldlist%shortname(n), &
                                       ...
                                       consdmap, rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=7236, file="module_MEDIATOR.F90")) return  ! bail out

        elseif (fldlist%mapping(n) == 'patch') then
          if (.not. okpatch) then
            call ESMF_LogWrite(trim(subname)//trim(lstring)//": ERROR RH not available for "//trim(fldlist%mapping(n))// &
              ": fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_ERROR, line=7241, file="module_MEDIATOR.F90", rc=dbrc)
            rc = ESMF_FAILURE
            return
          endif
          call FieldBundle_FieldRegrid(FBin ,fldlist%shortname(n), &
                                       ...
                                       patchmap,rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=7249, file="module_MEDIATOR.F90")) return  ! bail out
        ...
        elseif (fldlist%mapping(n) == 'copy') then
          ...
          if (.not. okfcopy) then
            if (.not. okconsf) then
              call ESMF_LogWrite(trim(subname)//trim(lstring)//": ERROR RH not available for "//trim(fldlist%mapping(n))// &
                ": fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_ERROR, line=7259, file="module_MEDIATOR.F90", rc=dbrc)
              rc = ESMF_FAILURE
              return
            else
              call ESMF_LogWrite(trim(subname)//trim(lstring)//": NOTE using conservative instead of copy for"// &
                " fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_INFO, line=7264, file="module_MEDIATOR.F90", rc=dbrc)
              call FieldBundle_FieldRegrid(FBin ,fldlist%shortname(n), &
                                           FBout,fldlist%shortname(n), &
                                           consfmap,rc)
              if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
                line=7269, file="module_MEDIATOR.F90")) return  ! bail out
            endif
          else
            call FieldBundle_FieldRegrid(FBin ,fldlist%shortname(n), &
                                         FBout,fldlist%shortname(n), &
                                         fcopymap,rc)
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=7276, file="module_MEDIATOR.F90")) return  ! bail out
          endif

        else
          call ESMF_LogWrite(trim(subname)//trim(lstring)//": ERROR unrecognized mapping "//trim(fldlist%mapping(n))// &
            ": fld="//trim(fldlist%shortname(n)), ESMF_LOGMSG_ERROR, line=7281, file="module_MEDIATOR.F90", rc=dbrc)
          rc = ESMF_FAILURE
          return
        endif
      ...
      if (FieldBundle_FldChk(FBin , fldlist%shortname(n), rc=rc) .and. &
        ...
        if (dbug_flag > 1) then
          ...
          call FieldBundle_FieldRegrid(FBin ,fldlist%shortname(n), &
                                       ...
                                       nearestmap,rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=7352, file="module_MEDIATOR.F90")) return  ! bail out
      endif
    enddo
...
!BL2017
  ...
  subroutine FieldBundle_FieldRegrid(FBin,fldin,FBout,fldout,RH,rc)
    ...
    if (FieldBundle_FldChk(FBin , trim(fldin) , rc=rc) .and. &
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7387, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine FieldBundle_FieldMerge(FBout, fnameout, &
    ...
    if (.not. FieldBundle_FldChk(FBout, trim(fnameout), rc=rc)) then
      call ESMF_LogWrite(trim(subname)//": WARNING output field not in FBout, skipping merge of: "//trim(fnameout), ESMF_LOGMSG_WARNING, line=7452, file="module_MEDIATOR.F90", rc=dbrc)
      return
    endif
    call FieldBundle_GetFldPtr(FBout, trim(fnameout), dataOut, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7457, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if ((present(FBinA) .and. .not.present(fnameA)) .or. &
      ...
      call ESMF_LogWrite(trim(subname)//": ERROR fname not present with FBin", ESMF_LOGMSG_ERROR, line=7471, file="module_MEDIATOR.F90", rc=dbrc)
      rc = ESMF_FAILURE
      return
    endif
    ...
    if (.not. FBinfound) then
      call ESMF_LogWrite(trim(subname)//": WARNING field: "//trim(fname)//" :not found in FBin, skipping merge of: "//trim(fnameout), ESMF_LOGMSG_WARNING, line=7509, file="module_MEDIATOR.F90", rc=dbrc)
      return
    endif
    ...
    do n = 1,5
      ...
      if (n == 1 .and. present(FBinA)) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=7523, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      elseif (n == 2 .and. present(FBinB)) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=7534, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      elseif (n == 3 .and. present(FBinC)) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=7545, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      elseif (n == 4 .and. present(FBinD)) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=7556, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      elseif (n == 5 .and. present(FBinE)) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=7567, file="module_MEDIATOR.F90")) return  ! bail out
      ...
      if (FBinfound) then
        if (.not.FldPtr_SameCheck(dataPtr, dataOut, subname, rc)) then
          call ESMF_LogWrite(trim(subname)//": ERROR FBin wrong size", ESMF_LOGMSG_ERROR, line=7577, file="module_MEDIATOR.F90", rc=dbrc)
          rc = ESMF_FAILURE
          return
        endif
        ...
        if (wgtfound) then
          if (.not.FldPtr_SameCheck(dataPtr, wgt, subname, rc)) then
            call ESMF_LogWrite(trim(subname)//": ERROR wgt wrong size", ESMF_LOGMSG_ERROR, line=7584, file="module_MEDIATOR.F90", rc=dbrc)
            rc = ESMF_FAILURE
            return
          endif
          do j = lb2,ub2
  ...
  subroutine state_reset(State, value, rc)
    ...
    call ESMF_StateGet(State, itemCount=fieldCount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7641, file="module_MEDIATOR.F90")) return  ! bail out
    allocate(fieldNameList(fieldCount))
    call ESMF_StateGet(State, itemNameList=fieldNameList, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7645, file="module_MEDIATOR.F90")) return  ! bail out
    do n = 1, fieldCount
      call State_GetFldPtr(State, fieldNameList(n), dataPtr, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7649, file="module_MEDIATOR.F90")) return  ! bail out
...
!      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
!        line=7694, file="module_MEDIATOR.F90")) return  ! bail out

    else

      call ESMF_FieldBundleGet(FieldBundle, fieldCount=fieldCount, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7700, file="module_MEDIATOR.F90")) return  ! bail out
      allocate(fieldNameList(fieldCount))
      call ESMF_FieldBundleGet(FieldBundle, fieldNameList=fieldNameList, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7704, file="module_MEDIATOR.F90")) return  ! bail out
      do n = 1, fieldCount
        call FieldBundle_GetFldPtr(FieldBundle, fieldNameList(n), dataPtr, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=7708, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine fieldBundle_diagnose(FieldBundle, string, rc)
    ...
    call ESMF_FieldBundleGet(FieldBundle, fieldCount=fieldCount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7756, file="module_MEDIATOR.F90")) return  ! bail out
    allocate(fieldNameList(fieldCount))
    call ESMF_FieldBundleGet(FieldBundle, fieldNameList=fieldNameList, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7760, file="module_MEDIATOR.F90")) return  ! bail out
    do n = 1, fieldCount
      call FieldBundle_GetFldPtr(FieldBundle, fieldNameList(n), dataPtr, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=7764, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine array_diagnose(array, string, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7807, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine state_diagnose(State, string, rc)
    ...
    call ESMF_StateGet(State, itemCount=fieldCount, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7848, file="module_MEDIATOR.F90")) return  ! bail out
    allocate(fieldNameList(fieldCount))
    call ESMF_StateGet(State, itemNameList=fieldNameList, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7852, file="module_MEDIATOR.F90")) return  ! bail out
    do n = 1, fieldCount
      call State_GetFldPtr(State, fieldNameList(n), dataPtr, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
  ...
  subroutine fieldBundle_copyFB2FB(FBout, FBin, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7888, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine fieldBundle_copyST2FB(FBout, STin, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=7942, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    do n = 1, fieldCount
      ...
      if (exists) then
        ...
        if (.not.FldPtr_SameCheck(dataPtro, dataPtri, subname, rc)) then
           call ESMF_LogWrite(trim(subname)//": ERROR in dataPtr size ", ESMF_LOGMSG_ERROR, line=8003, file="module_MEDIATOR.F90", rc=rc)
           return
        endif
  ...
  subroutine fieldBundle_accumST2FB(FBout, STin, copy, rc)
    ...
    do n = 1, fieldCount
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=8068, file="module_MEDIATOR.F90")) return  ! bail out
      if (itemType /= ESMF_STATEITEM_NOTFOUND) then

        call State_GetFldPtr(STin, fieldNameList(n), dataPtrS, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8073, file="module_MEDIATOR.F90")) return  ! bail out
        call FieldBundle_GetFldPtr(FBout, fieldNameList(n), dataPtrB, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8076, file="module_MEDIATOR.F90")) return  ! bail out

        if (.not.FldPtr_SameCheck(dataPtrS, dataPtrB, subname, rc)) then
           call ESMF_LogWrite(trim(subname)//": ERROR in dataPtr size ", ESMF_LOGMSG_ERROR, line=8079, file="module_MEDIATOR.F90", rc=rc)
           return
        endif
  ...
  subroutine fieldBundle_accumFB2ST(STout, FBin, copy, rc)
    ...
    do n = 1, fieldCount
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=8145, file="module_MEDIATOR.F90")) return  ! bail out
      if (itemType /= ESMF_STATEITEM_NOTFOUND) then

        call FieldBundle_GetFldPtr(FBin, fieldNameList(n), dataPtrB, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8150, file="module_MEDIATOR.F90")) return  ! bail out
        call State_GetFldPtr(STout, fieldNameList(n), dataPtrS, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8153, file="module_MEDIATOR.F90")) return  ! bail out

        if (.not.FldPtr_SameCheck(dataPtrS, dataPtrB, subname, rc)) then
           call ESMF_LogWrite(trim(subname)//": ERROR in dataPtr size ", ESMF_LOGMSG_ERROR, line=8156, file="module_MEDIATOR.F90", rc=rc)
           return
        endif
  ...
  logical function FieldBundle_FldChk(FB, fldname, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8204, file="module_MEDIATOR.F90")) return  ! bail out
    if (isPresent) then
  ...
  subroutine FieldBundle_GetFldPtr(FB, fldname, fldptr, rc)
    ...
    if (.not. FieldBundle_FldChk(FB, trim(fldname), rc=rc)) then
      call ESMF_LogWrite(trim(subname)//": ERROR field not in FB "//trim(fldname), ESMF_LOGMSG_ERROR, line=8233, file="module_MEDIATOR.F90", rc=dbrc)
      rc = ESMF_FAILURE
      return
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8240, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_FieldGet(lfield, farrayPtr=fldptr, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8243, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine FieldBundle_SetFldPtr(FB, fldname, val, rc)
    ...
    if (.not. FieldBundle_FldChk(FB, trim(fldname), rc=rc)) then
      call ESMF_LogWrite(trim(subname)//": ERROR field not in FB "//trim(fldname), ESMF_LOGMSG_ERROR, line=8270, file="module_MEDIATOR.F90", rc=dbrc)
      rc = ESMF_FAILURE
      return
    endif
    ...
    call ESMF_FieldBundleGet(FB, fieldName=trim(fldname), field=lfield, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8277, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_FieldGet(lfield, farrayPtr=fldptr, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8280, file="module_MEDIATOR.F90")) return  ! bail out
...
!    call ESMF_StatePrint(ST,rc=dbrc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8313, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_FieldGet(lfield, farrayPtr=fldptr, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8316, file="module_MEDIATOR.F90")) return  ! bail out
...
!    call ESMF_StatePrint(ST,rc=dbrc)
  ...
  logical function FldPtr_SameCheck(fldptr1, fldptr2, cstring, rc)
    ...
    if (lbound(fldptr2,2) /= lbound(fldptr1,2) .or. &
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=8384, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine FldGrid_Print(field, string, rc)
    ...
    call ESMF_FieldGet(field, grid=grid, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8418, file="module_MEDIATOR.F90")) return  ! bail out
      
    call Grid_Print(grid, string, rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8422, file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_FieldGet(field,farrayPtr=dataptr,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8426, file="module_MEDIATOR.F90")) return  ! bail out

    write (msgString,*) trim(subname)//":"//trim(string)//": dataptr bounds dim=1 ",lbound(dataptr,1),ubound(dataptr,1)
    call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8431, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine Grid_Print(grid, string, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8467, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8477, file="module_MEDIATOR.F90")) return  ! bail out
    
    write (msgString,*) trim(subname)//":"//trim(string)//": dimCount=", dimCount
    call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8482, file="module_MEDIATOR.F90")) return  ! bail out

    write (msgString,*) trim(subname)//":"//trim(string)//": tileCount=", tileCount
    call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8487, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8497, file="module_MEDIATOR.F90")) return  ! bail out
      
    write (msgString,*) trim(subname)//":"//trim(string)//": minIndexPTile=", minIndexPTile
    call ESMF_LogWrite(msgString, ESMF_LOGMSG_INFO, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8502, file="module_MEDIATOR.F90")) return  ! bail out
...
!-----------------------------------------------------------------------------
  subroutine ClockTimePrint(clock,string,rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8547, file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8552, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeGet(time,timestring=timestr,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
    ...
    call ESMF_TimeGet(time,timestring=timestr,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8563, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_LogWrite(trim(lstring)//": stoptime = "//trim(timestr), ESMF_LOGMSG_INFO, rc=dbrc)

    call ESMF_ClockGet(clock,timestep=timestep,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8568, file="module_MEDIATOR.F90")) return  ! bail out
    call ESMF_TimeIntervalGet(timestep,timestring=timestr,rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8571, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine Grid_Write(grid, string, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8601, file="module_MEDIATOR.F90")) return
    if (isPresent) then
      call ESMF_GridGetCoord(grid, coordDim=1, staggerLoc=ESMF_STAGGERLOC_CENTER, array=array, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8604, file="module_MEDIATOR.F90")) return
      call ESMF_ArraySet(array, name="lon_center", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8606, file="module_MEDIATOR.F90")) return
      call Array_diagnose(array,trim(string)//"_grid_coord1", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8608, file="module_MEDIATOR.F90")) return
      call ESMF_ArrayWrite(array, trim(string)//"_grid_coord1.nc", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8610, file="module_MEDIATOR.F90")) return
      call ESMF_GridGetCoord(grid, coordDim=2, staggerLoc=ESMF_STAGGERLOC_CENTER, array=array, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8612, file="module_MEDIATOR.F90")) return
      call ESMF_ArraySet(array, name="lat_center", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8614, file="module_MEDIATOR.F90")) return
      call Array_diagnose(array,trim(string)//"_grid_coord2", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8616, file="module_MEDIATOR.F90")) return
      call ESMF_ArrayWrite(array, trim(string)//"_grid_coord2.nc", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8618, file="module_MEDIATOR.F90")) return
    endif

    ! -- corners --

    call ESMF_GridGetCoord(grid, staggerLoc=ESMF_STAGGERLOC_CORNER, isPresent=isPresent, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8624, file="module_MEDIATOR.F90")) return
    if (isPresent) then
      call ESMF_GridGetCoord(grid, coordDim=1, staggerLoc=ESMF_STAGGERLOC_CORNER, array=array, rc=rc)
      if (.not. ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8627, file="module_MEDIATOR.F90")) then
        call ESMF_ArraySet(array, name="lon_corner", rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8629, file="module_MEDIATOR.F90")) return
        call Array_diagnose(array,trim(string)//"_grid_corner1", rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8631, file="module_MEDIATOR.F90")) return
        call ESMF_ArrayWrite(array, trim(string)//"_grid_corner1.nc", rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8633, file="module_MEDIATOR.F90")) return
      endif
      call ESMF_GridGetCoord(grid, coordDim=2, staggerLoc=ESMF_STAGGERLOC_CORNER, array=array, rc=rc)
      if (.not. ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8636, file="module_MEDIATOR.F90")) then
        call ESMF_ArraySet(array, name="lat_corner", rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8638, file="module_MEDIATOR.F90")) return
        call Array_diagnose(array,trim(string)//"_grid_corner2", rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8640, file="module_MEDIATOR.F90")) return
        call ESMF_ArrayWrite(array, trim(string)//"_grid_corner2.nc", rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8642, file="module_MEDIATOR.F90")) return
      endif
    endif
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8650, file="module_MEDIATOR.F90")) return
    if (isPresent) then
      call ESMF_GridGetItem(grid, staggerLoc=ESMF_STAGGERLOC_CENTER, itemflag=ESMF_GRIDITEM_MASK, array=array, rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8653, file="module_MEDIATOR.F90")) return
      call ESMF_ArraySet(array, name="mask", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8655, file="module_MEDIATOR.F90")) return
      call Array_diagnose(array,trim(string)//"_grid_mask", rc=rc)
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8657, file="module_MEDIATOR.F90")) return
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, line=8665, file="module_MEDIATOR.F90")) return
    if (isPresent) then
  ...
  subroutine fld_list_add(fldlist, stdname, transferOffer, mapping)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=trim(subname)//&
      ...
      line=8709, file="module_MEDIATOR.F90")) return  ! bail out
  ...
  function NEMS_DistGridMatch(distGrid1, distGrid2, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8805,file="module_MEDIATOR.F90")) return  ! bail out

    call ESMF_DistGridGet(distGrid2, &
      dimCount=dimCount2, tileCount=tileCount2, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8810,file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8840,file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=8847,file="module_MEDIATOR.F90")) return  ! bail out
  ...
  subroutine NEMS_GridCopyCoord(gridcomp, gridSrc, gridDst, staggerloc, tolerance, compare, invert, rc)
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=8946,file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=8952,file="module_MEDIATOR.F90")) return  ! bail out
    ...
    if (.NOT. NEMS_DistGridMatch(distGrid1=distGridSrc, distGrid2=distGridDst, rc=rc)) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        ...
        line=8957, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    if ( dimCountSrc /= dimCountDst) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        ...
        line=8964, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    if ( coordTypeKindSrc /= coordTypeKindDst) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        ...
        line=8971, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    if ( coordSysSrc /= coordSysDst) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        ...
        line=8978, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    do staggerlocIndex=1, size(staggerloc)
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8987,file="module_MEDIATOR.F90")) return  ! bail out
      if(isPresentSrc) then
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8993,file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_GridGetCoord(gridDst, &
          staggerloc=staggerloc(staggerlocIndex), &
          isPresent=isPresentDst, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=8998,file="module_MEDIATOR.F90")) return  ! bail out
        if(.NOT.isPresentDst) then
          ...
          if(l_compare .EQV. .TRUE.) then
            ...
            call ESMF_LogSetError(ESMF_RC_NOT_IMPL, &
              ...
              line=9009, file="module_MEDIATOR.F90", rcToReturn=rc)
              return  ! bail out
          end if
        endif
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9017,file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_ArrayGet(coordArraySrc, distGrid=distGridSrc, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9020,file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_ArrayGet(coordArrayDst, distGrid=distGridDst, &
          dimCount=dimCountDst, deCount=deCountDst, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9024,file="module_MEDIATOR.F90")) return  ! bail out
        if (.NOT. NEMS_DistGridMatch(distGrid1=distGridSrc, distGrid2=distGridDst, rc=rc)) then
        call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
          msg=SUBNAME//": Unable to redistribute coordinates. DistGrids do not match.", &
          line=9028, file="module_MEDIATOR.F90", rcToReturn=rc)
          return  ! bail out
        endif
        ...
        if ( ANY( l_invert == dimIndex )) then
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9035,file="module_MEDIATOR.F90")) return  ! bail out

          call ESMF_VMGet(vm, localPet=localPet, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9039,file="module_MEDIATOR.F90")) return  ! bail out            

          if (localPet == 0) then
            call ESMF_DistGridGet(distGridDst, deCount=deCountDst, rc=rc)
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=9044,file="module_MEDIATOR.F90")) return  ! bail out

            allocate(elementCountPDeDst(deCountDst))
            call ESMF_DistGridGet(distGridDst, &
              elementCountPDe=elementCountPDeDst, rc=rc)
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=9050,file="module_MEDIATOR.F90")) return  ! bail out
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=9081,file="module_MEDIATOR.F90")) return  ! bail out
            ...
            if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
              line=9089,file="module_MEDIATOR.F90")) return  ! bail out
          endif
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9098,file="module_MEDIATOR.F90")) return  ! bail out

        else
          call ESMF_ArrayRedistStore(coordArraySrc, coordArrayDst, routehandle=routehandle, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9103,file="module_MEDIATOR.F90")) return  ! bail out
          ...
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9109,file="module_MEDIATOR.F90")) return  ! bail out
        endif
      else
        call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
          msg=SUBNAME//": SOURCE GRID MISSING STAGGER LOCATION", &
          line=9114, file="module_MEDIATOR.F90", rcToReturn=rc)
        return  ! bail out
      endif
    enddo
    enddo
  ...
  subroutine NEMS_GridCopyItem(gridcomp, gridSrc, gridDst, item, tolerance, compare, invert, rc)
    ...
    call ESMF_GridGet(gridDst, distGrid=distGridDst, &
      ...
      coordSys=coordSysDst, rc=rc)
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
        line=9186,file="module_MEDIATOR.F90")) return  ! bail out

    if (.NOT. NEMS_DistGridMatch(distGrid1=distGridSrc, distGrid2=distGridDst, rc=rc)) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        msg=SUBNAME//": Unable to redistribute coordinates. DistGrids do not match.", &
        line=9191, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    if ( dimCountSrc /= dimCountDst) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        msg=SUBNAME//": DIMCOUNT MISMATCH", &
        line=9198, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    if ( coordTypeKindSrc /= coordTypeKindDst) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        msg=SUBNAME//": COORDTYPEKIND MISMATCH", &
        line=9205, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    if ( coordSysSrc /= coordSysDst) then
      call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
        msg=SUBNAME//": COORDSYS MISMATCH", &
        line=9212, file="module_MEDIATOR.F90", rcToReturn=rc)
      return  ! bail out
    endif
    ...
    do itemIndex=1, size(item)
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9220,file="module_MEDIATOR.F90")) return  ! bail out
      if(isPresentSrc) then
        call ESMF_GridGetItem(gridSrc, itemflag=item(itemIndex), &
          staggerloc=l_staggerloc, array=itemArraySrc, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9225,file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_GridGetItem(gridDst, itemflag=item(itemIndex), &
          staggerloc=l_staggerloc, isPresent=isPresentDst, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9229,file="module_MEDIATOR.F90")) return  ! bail out
        if(.NOT.isPresentDst) then
          call ESMF_GridAddItem(gridDst, itemflag=item(itemIndex), &
            staggerLoc=l_staggerloc, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9234,file="module_MEDIATOR.F90")) return  ! bail out
        else
          if(l_compare .EQV. .TRUE.) then
            ! TODO: Compare existing coordinates
            call ESMF_LogSetError(ESMF_RC_NOT_IMPL, &
              msg=SUBNAME//": Cannot compare existing coordinates.", &
              line=9240, file="module_MEDIATOR.F90", rcToReturn=rc)
              return  ! bail out
          end if
        endif
        call ESMF_GridGetItem(gridDst, itemflag=item(itemIndex), &
        ...
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9247,file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_ArrayGet(itemArraySrc, distGrid=distGridSrc, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9250,file="module_MEDIATOR.F90")) return  ! bail out
        call ESMF_ArrayGet(itemArrayDst, distGrid=distGridDst, rc=rc)
        if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
          line=9253,file="module_MEDIATOR.F90")) return  ! bail out
        if (.NOT. NEMS_DistGridMatch(distGrid1=distGridSrc, distGrid2=distGridDst, rc=rc)) then
          call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
            msg=SUBNAME//": Unable to redistribute coordinates. DistGrids do not match.", &
            line=9257, file="module_MEDIATOR.F90", rcToReturn=rc)
            return  ! bail out
        endif
        ...
        if ( ANY( l_invert > 0 )) then
          ! TODO: Invert Item
            call ESMF_LogSetError(ESMF_RC_NOT_IMPL, &
              ...
              line=9265, file="module_MEDIATOR.F90", rcToReturn=rc)
              return  ! bail out
        else
          call ESMF_ArrayRedistStore(itemArraySrc, itemArrayDst, routehandle=routehandle, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9270,file="module_MEDIATOR.F90")) return  ! bail out
          call ESMF_ArrayRedist(itemArraySrc, itemArrayDst, routehandle=routehandle, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9273,file="module_MEDIATOR.F90")) return  ! bail out
          call ESMF_ArrayRedistRelease(routehandle=routehandle, rc=rc)
          if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
            line=9276,file="module_MEDIATOR.F90")) return  ! bail out
        endif
      else
        call ESMF_LogSetError(ESMF_RC_ARG_BAD, &
          msg=SUBNAME//": SOURCE GRID MISSING ITEM", &
          line=9281, file="module_MEDIATOR.F90", rcToReturn=rc)
        return  ! bail out
      endif
    enddo
