...
print(tide_spin_start_date)
print(tide_spin_end_date)
print(wave_spin_end_date)
...
if run_option == 'tide_spinup':    
    ...
    print("entered wav&best_track2ocn ................ \n")
    Ver             = 'v2.0' 
...
if run_option in ['tide_spinup','tide_baserun','best_track2ocn']:    
    ...
    print("entered NEMS wav2ocn wav&best_track2ocn............... \n")
    #NEMS settings
